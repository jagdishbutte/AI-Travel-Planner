        ...
        <div className="bg-gray-800 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="bg-gray-700/50 rounded-lg p-4">
              ...
              <p className="text-2xl font-semibold">{trip.travelers}</p>
            </div>
            <div className="bg-gray-700/50 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-sm text-gray-300">
                💡 Book flights and accommodations in advance to get better
                deals
              </p>
            </div>
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-sm text-gray-300">
                💡 Consider local transportation passes for cost-effective
                travel
              </p>
            </div>
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-sm text-gray-300">
                💡 Look for combo tickets for attractions to save money
              </p>
            </div>
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-sm text-gray-300">
                💡 Mix dining options between restaurants and local markets
              </p>
            </div>
          </div>
        </div>

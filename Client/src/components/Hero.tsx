...
export const Hero = () => {
  ...
  return (
      <div className="relative min-h-screen flex flex-col">
          <Navbar />
          {/* Hero Section */}
          <div className="relative flex items-center min-h-screen flex-1">
              <div
                  className="absolute blur-sm inset-0 z-0"
                  style={{
              ...
              <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
                  <motion.div
                      ...
                      className="max-w-3xl"
                  >
                      <h1 className="text-5xl md:text-6xl font-extrabold leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-pink-200 to-purple-400">
                          Your AI Travel Companion for Perfect Adventures
                      </h1>
                      <p className="text-xl md:text-2xl mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-pink-200">
                          Plan personalized trips with AI-powered
